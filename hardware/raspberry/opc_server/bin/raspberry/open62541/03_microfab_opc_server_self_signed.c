/* OPC UA Server with access control / encryption via self signed certificates
...
int main(void) {
    ...
    certificate = loadFile(argv[1]); // <server-certificate.der>
    privateKey = loadFile(argv[2]); // <private-key.der>
